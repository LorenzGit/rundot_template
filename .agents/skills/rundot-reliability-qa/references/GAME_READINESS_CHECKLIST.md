...
| Localization | Player-facing copy is centralized; selected languages, fallback, formatting, long-text/font review, and localized notifications are checked. | |
